...
public IntakeIOKraken() {
    ...
    m_rotationMotorFollow.setControl(new Follower(m_constants.rotationMotorID, MotorAlignmentValue.Opposed));
...
public void setAngle(double angleDegrees, IntakeIOInputs inputs){
    ...
    double motorRotations = (angleDegrees-inputs.rotationDegrees) * m_constants.rotationGearRatio / 360;
